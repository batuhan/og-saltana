...
const { getCurrencyDecimal, isValidCurrency } = require('./currency')
...
function getPriceAfterFees(args) {
  let useFeesPercent =
    typeof args.ownerFeesPercent !== 'undefined' &&
    typeof args.takerFeesPercent !== 'undefined'

  const useFees =
    typeof args.ownerFees !== 'undefined' &&

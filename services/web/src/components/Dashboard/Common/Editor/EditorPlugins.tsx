...
import {
  ...
  LINK_TYPE,
  pluginLink,
} from 'wix-rich-content-plugin-link'
import {
...
import {
  ...
  EMOJI_TYPE,
  pluginEmoji,
} from 'wix-rich-content-plugin-emoji'
import {
  createImagePlugin,
  IMAGE_TYPE,
  pluginImage,
...
import {
  ...
  GIPHY_TYPE,
  pluginGiphy,
} from 'wix-rich-content-plugin-giphy'
import {
...
import {
  ...
  MAP_TYPE,
  pluginMap,
} from 'wix-rich-content-plugin-map'
import {
  createPollPlugin,
  pluginPoll,
  POLL_TYPE,
} from 'wix-rich-content-plugin-social-polls'
import {
...
import { mockFetchUrlPreviewData } from './_/utils/linkPreviewUtil'
import {
  createIndentPlugin,
  pluginIndent,
  INDENT_TYPE,
} from 'wix-rich-content-plugin-indent'
import {
  createTablePlugin,
  pluginTable,
  TABLE_TYPE,
} from 'wix-rich-content-plugin-table'
import {
...
} from './_/utils/verticalEmbedUtil'
import {
  customForegroundStyleFn,
  styleSelectionPredicate,
  colorScheme,
  customBackgroundStyleFn,
} from './_/utils/text-color-style-fn'

export const ricosEditorPlugins: Record<
  string,
  EditorPluginCreator<unknown>
> = {
...
export const editorPluginsMap: Record<
  string,
...
const config: RichContentEditorProps['config'] = {
  ...
  [VERTICAL_EMBED_TYPE]: {
    ...
    getIsVisiblePromise: (type, locale) =>
      MockGetIsVisiblePromise(type, locale),
    // slimLayout: true,
  },
  // [EXTERNAL_EMOJI_TYPE]: {},
  [VIDEO_TYPE]: {
  ...
  getToolbarSettings: ({ textButtons }) => [
    ...
    { name: TOOLBARS.FOOTER, footerToolbarConfig },
    {
      ...
      getButtons: () => ({
        desktop: textButtons.desktop.filter(
          (b) => b !== FORMATTING_BUTTONS.TITLE
        ),
        mobile: {

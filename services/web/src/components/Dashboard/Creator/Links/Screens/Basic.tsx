...
export default function CreatorDashboardLinkBasicScreen() {
  ...
  return (
    <main className="max-w-3xl mx-auto pt-5 pb-12 px-4 lg:pb-16">
      <NextSeo title="Basic" />
      <Example asset={asset} />
          ...
          <div className="mb-4">
            ...
            <div className="mt-1">
              <input
                ...
                className="block focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-5 pr-12 sm:text-sm border-gray-300 rounded-md"

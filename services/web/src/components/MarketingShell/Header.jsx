            ...
            <div tw="max-w-7xl mx-auto flex justify-between items-center px-4 py-5 sm:px-6 sm:py-4 lg:px-8 md:justify-start md:space-x-10">
              ...
              <div tw="hidden md:flex-1 md:flex md:items-center md:justify-between">
                    ...
                    {({ open }) => (
                      <>§
                        ...
                        >
                          <Popover.Panel
                            static
                            tw="hidden md:block absolute z-10 top-full inset-x-0 transform shadow-lg bg-white"
                          >
                            ...
                            <div tw="bg-gray-50">
                              <div tw="max-w-7xl mx-auto space-y-6 px-4 py-5 sm:flex sm:space-y-0 sm:space-x-10 sm:px-6 lg:px-8">
                                {callsToAction.map((item) => (
                                  <div key={item.name} tw="flow-root">
                                    <a
                                      href={item.href}
                                      tw="-m-3 p-3 flex items-center rounded-md text-base font-medium text-gray-900 hover:bg-gray-100"
                                    >
                                      <item.icon tw="flex-shrink-0 h-6 w-6 text-gray-400" aria-hidden="true" />
                    ...
                    {({ open }) => (
                      <>
                        ...
                        >
                          <Popover.Panel
                            static
                            tw="hidden md:block absolute z-10 top-full inset-x-0 transform shadow-lg"
                          >
                            ...
                            <div tw="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2">
                              <nav tw="grid gap-y-10 px-4 py-8 bg-white sm:grid-cols-2 sm:gap-x-8 sm:py-12 sm:px-6 lg:px-8 xl:pr-12">
                                <div>
                                  ...
                                  <ul tw="mt-5 space-y-6">
                                    {company.map((item) => (
                                      <li key={item.name} tw="flow-root">
                                        <a
                                          href={item.href}
                                          tw="-m-3 p-3 flex items-center rounded-md text-base font-medium text-gray-900 hover:bg-gray-50"
                                        >
                                          <item.icon
                                            tw="flex-shrink-0 h-6 w-6 text-gray-400"
                                            aria-hidden="true"
                                          />
                                          <span tw="ml-4">{item.name}</span>
                                        </a>
                                      </li>
                                    ))}
                                  </ul>
                              ...
                              <div tw="bg-gray-50 px-4 py-8 sm:py-12 sm:px-6 lg:px-8 xl:pl-12">
                                <div>
                                  ...
                                  <ul tw="mt-6 space-y-6">
                                    {blogPosts.map((post) => (
                                      <li key={post.id} tw="flow-root">
                                        <a href={post.href} tw="-m-3 p-3 flex rounded-lg hover:bg-gray-100">
                                          <div tw="hidden sm:block flex-shrink-0">
                                            <img
                                              tw="w-32 h-20 object-cover rounded-md"
                                              src={post.imageUrl}
                                              alt=""
                                            />
                                          </div>
                                          <div tw="w-0 flex-1 sm:ml-8">
                                            <h4 tw="text-base font-medium text-gray-900 truncate">
                                              {post.name}
                                            </h4>
                                            <p tw="mt-1 text-sm text-gray-500">{post.preview}</p>
                                          </div>
                                        </a>
                                      </li>
                                    ))}
                ...
                <div tw="flex items-center md:ml-12">
                  ...
                  <a
                    href="#"
                    tw="ml-8 inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700"
                  >
                    Sign up
                  </a>
                </div>
            ...
            >
              <div tw="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
                <div tw="pt-5 pb-6 px-5 sm:pb-8">
                  ...
                  <div tw="mt-6 sm:mt-8">
                    <nav>
                      <div tw="grid gap-7 sm:grid-cols-2 sm:gap-y-8 sm:gap-x-4">
                        {solutions.map((item) => (
                          <a
                            key={item.name}
                            href={item.href}
                            tw="-m-3 flex items-center p-3 rounded-lg hover:bg-gray-50"
                          >
                            <div tw="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-indigo-500 text-white sm:h-12 sm:w-12">
                              <item.icon tw="h-6 w-6" aria-hidden="true" />
                            </div>
                            <div tw="ml-4 text-base font-medium text-gray-900">{item.name}</div>
                          </a>
                        ))}
                      </div>
                      <div tw="mt-8 text-base">

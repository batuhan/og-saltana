...
test('generate internal availability periods without transactions', (t) => {
  ...
  const expectedAvailablePeriods = [
    ...
    },
    {
      ...
      endDate: '2018-01-16T00:00:00.000Z',
      quantity: 4,
    },
    {
      startDate: '2018-01-16T00:00:00.000Z',
    ...
    {
      startDate: '2018-01-22T00:00:00.000Z',
...
test('generate internal availability periods with transactions', (t) => {
  ...
  const transactions = [
    ...
    },
    {
      ...
      quantity: 1,
      status: 'validated',
    }, // overlap first transaction
    {
      id: '3',
      startDate: '2018-01-23T00:00:00.000Z',
  ...
  const expectedChunkAvailabilities = [
    ...
    {
      startDate: '2018-01-22T00:00:00.000Z',
      endDate: '2018-01-23T00:00:00.000Z',
      quantity: 5,
    },
    {
      startDate: '2018-01-23T00:00:00.000Z',
  ...
  const expectedChunkTransactions = [
    ...
    {
      id: '4',
      startDate: '2018-02-05T00:00:00.000Z',
      endDate: null,
      quantity: 2,
      status: 'validated',
    },
...
test('generate internal availability periods', (t) => {
  ...
  const internalPeriods = getAvailabilityPeriods({
    defaultQuantity,
    graphDates,
  })

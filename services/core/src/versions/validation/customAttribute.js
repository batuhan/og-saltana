...
const oldPaginationOrderByFields = ['name', 'createdDate', 'updatedDate']
...
schemas['2019-05-20'].create = {
  body: Joi.object()
    .keys({
      ...
      type: Joi.string()
        .valid('number', 'boolean', 'text', 'select', 'tags')
        .required(),
...
schemas['2019-05-20'].update = {
  params: objectIdParamsSchema,
  body: schemas['2019-05-20'].create.body.fork(['name', 'type'], (schema) =>
    schema.forbidden(),
  ),
}

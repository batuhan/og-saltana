...
function init(server, { middlewares, helpers } = {}) {
  ...
  server.get(
    ...
    checkPermissions(['link:list', 'link:list:all']),
  ...
  server.get(
    ...
    checkPermissions(['link:read', 'link:read:all']),
    wrapAction(async (req, res) => {
      let ctx = getRequestContext(req)
  ...
  server.post(
    ...
    checkPermissions(['link:create', 'link:create:all']),
    wrapAction(async (req, res) => {
      let ctx = getRequestContext(req)
  ...
  server.patch(
    ...
    checkPermissions(['link:edit', 'link:edit:all']),
    wrapAction(async (req, res) => {
      let ctx = getRequestContext(req)
  ...
  server.del(
    ...
    checkPermissions(['link:remove', 'link:remove:all']),
    wrapAction(async (req, res) => {
      let ctx = getRequestContext(req)
